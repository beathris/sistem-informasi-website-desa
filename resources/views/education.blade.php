...
@section('content')
    ...
    <div class="container-fluid">
        <a href="{{url('/education/create')}}" type="button" class="btn btn-success mb-3"><i
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <tr>
                @foreach($data as $education)
                    ...
                    <td>{{$education->female}}</td>
                    <td>{{$education->male}}</td>
                    <td>
                        <a href="{{url('/education/'.$education->id.'/edit')}}" type="button"
